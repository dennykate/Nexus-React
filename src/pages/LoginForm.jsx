...
const LoginForm = () => {
    ...
    <>
       ...
       <div className=" z-40   py-5 sm:py-12 md:py-12 md:px-5 lg:py-24 lg:px-7 2xl:px-5">
          ...
          <div className=" w-[90%] sm:w-[85%] xl:w-[85%]   mx-auto flex flex-col lg:flex-row  rounded-md shadow-lg ">
            ...
            {/* login form  */}
            <div className="w-full sm:px-8 border-2 bg-white text-tertiary py-10 xl:px-6 2xl:pt-20  ">
            {/* Upperlogin  */}
              <div className="Upperlogin   flex   justify-between items-center px-5 mb-8 md:items-start md:mb-12 lg:flex-col xl:flex-row xl:mb-9 2xl:mb-24 ">
              ...
              <div className="LowerRegister  w-full px-5 2xl:pr-28  ">
                ...
                <form action="" onSubmit={loginHandler} className="flex flex-col ">
                  ...
                  <input
                    className="py-2 px-[15px] w-full  border-[1px] rounded-md mb-5 md:mb-8 md:py-3  xl:mb-4 4"
                    type="email"
  ...
  <input type="checkbox" class="form-checkbox h-5 w-4 bg-gray-400   "/>
  <span class="ml-2 text-gray-400">  Keep me logged in</span>
</label>
                     
                    </div>
                    <div className="">
                        <p className='text-[15px] text-primary font-semibold underline'>Forgot Password</p>
                    </div>
                  </div>
